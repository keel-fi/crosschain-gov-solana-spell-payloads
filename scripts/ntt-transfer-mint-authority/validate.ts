...
const PAYLOAD = Buffer.from([
  ...
  27, 96, 188, 149, 134, 149, 164, 87, 22, 171, 207, 0, 5, 37, 249, 146, 67,
  177, 163, 234, 226, 85, 154, 57, 97, 164, 16, 202, 67, 147, 213, 244, 142,
  190, 63, 92, 141, 154, 197, 50, 67, 68, 24, 132, 119, 1, 0, 23, 211, 98, 159,
  254, 46, 203, 253, 37, 146, 244, 159, 101, 186, 52, 60, 25, 34, 128, 221, 86,
  160, 25, 229, 123, 44, 176, 218, 141, 157, 249, 250, 0, 0, 80, 34, 42, 155,
  98, 77, 54, 113, 10, 234, 25, 189, 75, 200, 91, 19, 17, 79, 3, 26, 140, 212,
  118, 35, 237, 167, 83, 191, 84, 38, 222, 225, 0, 0, 244, 181, 29, 37, 14, 218,
  57, 22, 114, 127, 162, 55, 148, 116, 113, 136, 165, 182, 126, 137, 124, 32,
  97, 119, 133, 20, 84, 231, 100, 13, 245, 218, 0, 1, 6, 221, 246, 225, 215,
  101, 161, 147, 217, 203, 225, 70, 206, 235, 121, 172, 28, 180, 133, 237, 95,
  91, 55, 145, 58, 140, 245, 133, 126, 255, 0, 169, 0, 0, 0, 40, 87, 237, 187,
  84, 168, 175, 241, 75, 5, 104, 238, 20, 144, 17, 150, 10, 99, 96, 143, 237,
  71, 209, 247, 252, 198, 164, 27, 204, 205, 98, 91, 56, 155, 22, 68, 199, 20,
  64, 232, 167,
]);
...
const main = async () => {
  ...
  // NTT Program.
  const excludedAddresses = [NTT_PROGRAM_ID.toString()];
